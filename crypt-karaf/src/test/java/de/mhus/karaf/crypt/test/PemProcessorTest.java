...
import de.mhus.crypt.karaf.CryptApiImpl;
...
import de.mhus.crypt.bc.EccSigner;
import de.mhus.crypt.bc.JavaRsaCipher;
        ...
        CryptApiImpl api =
                new CryptApiImpl() {
                    ...
                    public SignerProvider getSigner(String signer) throws NotFoundException {
                        if (signer.equals("ECC-BC")) return new EccSigner();
