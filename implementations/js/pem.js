...
//                    out = out + parseInt(buffer[0]+buffer[1]+buffer[2]+buffer[3], 16);
                    out = out + String.fromCharCode(parseInt(String.fromCharCode(buffer[0])+String.fromCharCode(buffer[1])+String.fromCharCode(buffer[2])+String.fromCharCode(buffer[3]),16));
                    mode = 0;
                    break;
            }
        }
